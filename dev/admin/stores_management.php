<?php
  ...
  if ($session->value('adminarea') != 'Active') {
    ...
    else if ($_REQUEST['do'] == 'activate_store') {## MyPHPAuction 2009 k basically stuff needs to be added here cause we will need to renew a subscription not just activate an account
      $db->query("UPDATE " . DB_PREFIX . "users SET
