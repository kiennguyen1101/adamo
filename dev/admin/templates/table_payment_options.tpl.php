...
<div class="mainhead"><img src="images/tables.gif" align="absmiddle">
   <?php echo AMSG_TABLES_MANAGEMENT;?>
</div>
...
<table width="100%" border="0" cellpadding="3" cellspacing="3" class="fside">
   ...
   <form action="table_payment_options.php" method="post">
      <tr>
         <td><b>
            <?php echo AMSG_CURRENT_PAYMENT_OPTIONS;?>
            </b> [ <a href="table_payment_options.php?do=add_option"><?php echo AMSG_ADD_PAYMENT_OPTION;?></a> ]</td>
      </tr>
      <tr>
         <td><table width="100%" border="0" cellpadding="3" cellspacing="1">
               ...
               <?php echo $payment_options_content;?>
            </table></td>
      </tr>
   </form>
</table>
