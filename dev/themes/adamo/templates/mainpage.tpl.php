              ...
              if (!empty($item_details[$counter]['name'])) {
                ...
                <table width="100%" border="0" cellspacing="1" cellpadding="3">
                  ...
                  <tr height="<?php echo $layout['hpfeat_width'] + 12; ?>">
                    <td align="center"><a href="<?php echo $auction_link; ?>"><img src="<?php echo ((!empty($main_image)) ? 'thumbnail.php?pic=' . $main_image . '&w=' . $layout['hpfeat_width'] . '&sq=Y' : 'themes/' . $setts['default_theme'] . '/images/system/noimg.gif'); ?>" border="0" alt="<?php echo $item_details[$counter]['name']; ?>"></a></td>
                  </tr>
                  <tr class="c2">
                    <td>
...
<?php if ($layout['nb_recent_auct']) { ?>
    ...
    <div><img src="themes/<?php echo $setts['default_theme']; ?>/images/pixel.gif" width="1" height="10"></div>
  <?php } ?>
      ...
      <tr class="c4" height="15">
        ...
        <td class="smallfont" width="100%">&nbsp;<b><?php echo MSG_ITEM_TITLE; ?><b></td>
              ...
              while ($item_details = mysql_fetch_array($sql_select_popular_items)) {
                ...
                <tr height="15" class="<?php echo $background; ?>">
                  <td width="11" id="bot"><img src="themes/<?php echo $setts['default_theme']; ?>/images/popular.gif" width="13" height="12" hspace="3"></td> 
          ...
          <?php if ($layout['nb_ending_auct']) { ?>
              ...
              <table width="100%" border="0" cellpadding="3" cellspacing="1" class="border">
                ...
                while ($item_details = mysql_fetch_array($sql_select_ending_items)) {
                  ...
                  <tr height="15" class="<?php echo $background; ?>"> 
                    <td width="11" id="bot"><img src="themes/<?php echo $setts['default_theme']; ?>/images/soon.gif" width="13" height="12" hspace="3"></td> 
                    <td nowrap="nowrap" class="smallfont" id="bot"><a href="<?php echo process_link('auction_details', array('name' => $item_details['name'], 'auction_id' => $item_details['auction_id'])); ?>"><img src="<?php echo ((!empty($item_details["media_url"])) ? 'thumbnail.php?pic=' . $item_details["media_url"] . '&w=50&sq=Y' : 'themes/' . $setts['default_theme'] . '/images/system/noimg.gif'); ?>" border="0" alt="<?php echo $item_details['name']; ?>" /></a>
                    </td> 
                ...
                <tr class="c4" height="15">
                  ...
                  <td class="smallfont" width="100%">&nbsp;<b><?php echo MSG_ITEM_TITLE; ?><b></td>
                        ...
                        while ($item_details = mysql_fetch_array($sql_select_recent_wa)) {
                          ...
                          <tr height="15" class="<?php echo $background; ?>">
                            <td width="11" id="bot"><img src="themes/<?php echo $setts['default_theme']; ?>/images/wanted.gif" width="13" height="12" hspace="3"></td> 
