(function(a) {
    a.widget("ui.rcarousel", {_create: function() {
            var d, e = a(this.element), b = this, c = this.options;
            ...
            var d = a(this.element), c = d.find("div.wrapper"), b = this.options;
            f.width(b.width).height(b.height);
            if (b.orientation === "horizontal") {
                a(f).css("marginRight", b.margin)
            } else {
                a(f).css({marginBottom: b.margin, "float": "none"})
            }
            if (e === "prev") {
            ...
            var c = a(this.element), b = c.data("data");
            d.each(function(e, f) {
                b.paths.push(a(f))
            });
            ...
            var b = this.options, c = a(this.element).data("data");
            if (d === "next") {
            ...
            b.data("data", {paths: [], pathsLen: 0, pages: [], lastPage: [], oldPageIndex: 0, pageIndex: 0, navigation: {}, animated: false, appended: false, hoveredOver: false})
        }, _generatePages: function() {
            var i = this, j = this.options, c = a(this.element).data("data"), b = j.visible, h = c.paths.length;
            function f() {
                c.pages = [];
                c.lastPage = [];
                c.pages[0] = [];
            ...
            function g() {
                var p = true, o = false, m = j.step, k, q, n, l;
            ...
            var k = this.options, e = a(this.element).data("data"), f = h || "next", j = b || e.pages[k.startAtPage], c = 0, g = j.length;
            if (f === "next") {
                for (var d = c; d < g; d++) {
            ...
            var c, j, f, l, g, m, n, p, b, h = a(this.element), o = this, q = this.options, e = a(this.element).data("data");
            if (e.appended) {
                j = e.oldPage
            } else {
            ...
            h.animate(g, q.speed, function() {
                ...
                o._trigger("pageLoaded", null, {page: l})
            });
            e.appended = false
        }, _goToNextPage: function(l) {
            var c, k, f, m, g, j, n, p, b, h = a(this.element), q = this.options, e = h.data("data"), o = this;
            if (e.appended) {
                k = e.oldPage
            } else {
            ...
            h.animate(g, q.speed, function() {
                ...
                o._trigger("pageLoaded", null, {page: m})
            });
            e.appended = false
        }, next: function() {
            var b = this.options, c = a(this.element).data("data");
            ...
            var b, e = a(this.element), c = e.find("div.wrapper").children(), d = e.data("data");
            c.each(function(f, g) {
                b = a(g);
            ...
            var e, b = this.options, d = a(this.element).data("data");
            switch (c) {
                case"speed":
                    this._checkOptionsValidity({speed: f});
                    b.speed = f;
                    a.Widget.prototype._setOption.apply(this, arguments);
                    break;
                case"auto":
                    e = a.extend(b.auto, f);
                    this._checkOptionsValidity({auto: e});
                    if (b.auto.enabled) {
                        this._autoMode(b.auto.direction)
                    }
            }
        }, _setStep: function(d) {
            var c, b = this.options, e = a(this.element).data("data");
            c = d || b.step;
            b.step = c;
            e.step = b.width * c
        }, _setCarouselHeight: function() {
            var b, e = a(this.element), d = a(this.element).data("data"), c = this.options;
            ...
            var d, e = a(this.element), b = this.options, c = a(this.element).data("data");
            if (b.orientation === "horizontal") {
                d = b.visible * b.width + b.margin * (b.visible - 1)
            } else {
                d = b.width
            }
            e.css({width: d, overflow: "hidden"})
        }, options: {visible: 3, step: 3, width: 100, height: 100, speed: 1000, margin: 0, orientation: "horizontal", auto: {enabled: false, direction: "next", interval: 5000}, startAtPage: 0, navigation: {next: "#ui-carousel-next", prev: "#ui-carousel-prev"}}})
}(jQuery));