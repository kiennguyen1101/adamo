function loadTxt()
{
    ...
    txtLang[4].innerHTML = "Ultimo seleccionado";
    txtLang[5].innerHTML = "Colores personalizados";

    document.getElementById("btnAddToCustom").value = unescape("a%F1adir a colores personalizados");
