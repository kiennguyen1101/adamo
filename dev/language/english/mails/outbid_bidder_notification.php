...
Ban quáº£n trá»‹ %5$s';
    ...
    send_mail($bid_details['email'], 'MÃ£ Ä‘áº¥u giÃ¡: ' . $bid_details['auction_id'] . ' - ThÃ´ng bÃ¡o giÃ¡ Ä‘áº·t Ä‘Ã£ bá»‹ vÆ°á»£t qua', $text_message, $setts['admin_email'], $html_message, null, $send);
  }
?>