...
if ($can_view)
{
	...
	$template->set('ad_image_thumbnails', $ad_image_thumbnails . '<br>' );
	...
	if ($setts['enable_other_items_adp'])
	{
		...
		$other_items = $db->random_rows('auctions a', 'a.auction_id, a.name, a.buyout_price, a.start_price, a.max_bid, a.currency, a.end_time', $select_condition, $layout['hpfeat_nb']);
