...
<?php if (IS_CATEGORIES == 1) { ?>
    <div style="width:740px;float:right;margin-top:20px">
    <?php } ?>
  <table width="100%" border="0" cellpadding="3" cellspacing="2" class="shared_table separate_line">
    <form action="compare_items.php" method="POST">
      ...
      <tr class="<?php echo (IS_SHOP == 1) ? 'c1_shop' : 'membmenu'; ?> no_border" valign="top">
        <td align="center"></td>
      ...
      <tr class="<?php echo (IS_SHOP == 1) ? 'c5_shop' : 'c5'; ?> no_border">
