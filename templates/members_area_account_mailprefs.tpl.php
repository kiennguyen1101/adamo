...
<form action="" method="post" name="mailprefs_form">
   ...
   <table width="100%" border="0" cellpadding="3" cellspacing="2" class="border">
      ...
      <tr class="c1">
         <td width="150" align="right"><?php echo MSG_SENT_MSG_NOTIF;?></td>
      ...
      <tr class="c1">
         <td width="150" align="right"><?php echo MSG_RECEIVED_MSG_NOTIF;?></td>
      ...
      <tr class="c1">
         <td width="150" align="right"><?php echo MSG_ITEM_SOLD_NOTIF;?></td>
      ...
      <tr class="c1">
         <td width="150" align="right"><?php echo MSG_ITEM_WON_NOTIF;?></td>
      ...
      <tr class="c1">
         <td width="150" align="right"><?php echo MSG_BID_PLACED_NOTIF;?></td>
      ...
      <tr class="c1">
         <td width="150" align="right"><?php echo MSG_OUTBID_NOTIF;?></td>
      ...
      <tr class="c1">
         <td width="150" align="right"><?php echo MSG_CONFIRM_TO_SELLER_NOTIF;?></td>
      ...
      <tr class="c1">
         <td width="150" align="right"><?php echo MSG_ITEM_CLOSED_NOTIF;?></td>
