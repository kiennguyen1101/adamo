...
<?php echo $buy_out_header_message; ?>

<table width="100%" border="0" cellpadding="0" cellspacing="2" class="shared_table">
  <tr>
...
<br>
<?php echo $buy_out_error_message; ?>
<?php echo $buy_out_page_content; ?>