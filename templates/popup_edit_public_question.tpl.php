...
<?php echo MSG_SUBMIT_EDIT_ANSWER;?>
</title>
...
<table border="0" width="100%" cellpadding="2" cellspacing="2" class="border contentfont">
   <form name="popup_form" onSubmit="return copyForm()">
      <input type="hidden" name="auction_id" value="<?php echo $auction_id;?>">
      <input type="hidden" name="wanted_ad_id" value="<?php echo $wanted_ad_id;?>">
      <input type="hidden" name="question_id" value="<?php echo $question_id;?>">
      <input type="hidden" name="option" value="post_answer">
      <tr class="c1">
         <td nowrap><strong><?php echo MSG_SUBMIT_ANSWER;?></strong>:</td>
         <td width="100%"><textarea name="message_content" style="width:100%; height: 60px;"><?php echo $message_content; ?></textarea></td>
      </tr>
      <tr>
         <td colspan="2" align="center" class="c2"><input type="button" value="<?php echo GMSG_PROCEED;?>" onClick="copyForm()"></td>
      </tr>
   </form>
</table>
</body>
