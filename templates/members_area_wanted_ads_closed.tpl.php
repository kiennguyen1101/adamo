...
<table width="100%" border="0" cellpadding="3" cellspacing="2" class="border">
	...
	<tr>
      <td colspan="8" class="c7"><b><?php echo MSG_MM_CLOSED_WANTED_ADS;?></b> (<?php echo $nb_items;?> <?php echo MSG_ITEMS;?>)
      </td>
   </tr>
   <tr valign="top">
      ...
      <td class="membmenu" align="center" class="contentfont"><?php echo MSG_RELIST;?>
      	<br>
      ...
      <td class="membmenu" align="center" class="contentfont"><?php echo GMSG_DELETE;?>
      	<br>
   ...
   <?php if ($nb_items>0) { ?>
   <tr class="membmenu">
      <td colspan="8" align="center"><input type="submit" name="form_closed_proceed" value="<?php echo GMSG_PROCEED;?>" <?php echo $disabled_button;?> /></td>
   </tr>
   <tr>
