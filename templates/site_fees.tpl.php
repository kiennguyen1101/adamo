...
<?php echo $site_fees_header_message; ?>
    ...
    <table width="100%" border="0" cellpadding="3" cellspacing="2" class="border fees_table">
      <tr>
        <td class="c3 fees_header" colspan="2">
          <strong>Ph? phí ngu?i bán tr?</strong> 
        </td>
    </tr>
  <?php if ($is_setup_fee) { ?>
      <tr>
  ...
  <?php if ($fee_row['second_cat_fee'] > 0) { ?>
      <tr class="c2">
            ...
            <td align="center" class="fees_column"><?php echo $fees->display_amount($fee_row['second_cat_fee']); ?>/s?n ph?m</td>
      </tr>
    <?php } ?>
  <?php if ($fee_row['picture_fee'] > 0) { ?>
      <tr class="c2">
            ...
            <td align="center" class="fees_column"><?php echo $fees->display_amount($fee_row['picture_fee']); ?>/s?n ph?m</td>
      </tr>
    <?php } ?>
  <?php if ($fee_row['hlitem_fee'] > 0) { ?>
      <tr class="c2">
            ...
            <td align="center" class="fees_column"><?php echo $fees->display_amount($fee_row['hlitem_fee']); ?>/s?n ph?m</td>
      </tr>
    <?php } ?>
  <?php if ($fee_row['bolditem_fee'] > 0) { ?>
      <tr class="c2">
            ...
            <td align="center" class="fees_column"><?php echo $fees->display_amount($fee_row['bolditem_fee']); ?>/s?n ph?m</td>
      </tr>
    <?php } ?>
  <?php if ($fee_row['catfeat_fee'] > 0) { ?>
      <tr class="c2">
            ...
            <td align="center" class="fees_column"><?php echo $fees->display_amount($fee_row['catfeat_fee']); ?>/s?n ph?m</td>
      </tr>
    <?php } ?>
  <?php if ($fee_row['hpfeat_fee'] > 0) { ?>
      <tr class="c2">
            ...
            <td align="center" class="fees_column"><?php echo $fees->display_amount($fee_row['hpfeat_fee']); ?>/s?n ph?m</td>
      </tr>
    <?php } ?>
  <?php if ($fee_row['rp_fee'] > 0) { ?>
      <tr class="c2">
            ...
            <td align="center" class="fees_column"><?php echo $fees->display_amount($fee_row['rp_fee']); ?>/s?n ph?m</td>
      </tr>
    <?php } ?>
  <?php if ($fee_row['swap_fee'] > 0) { ?>
      <tr class="c2">
            ...
            <td align="center" class="fees_column"><?php echo $fees->display_amount($fee_row['swap_fee']); ?>/s?n ph?m</td>
      </tr>
    <?php } ?>
  <?php if ($fee_row['buyout_fee'] > 0) { ?>
      <tr class="c2">
            ...
            <td align="center" class="fees_column"><?php echo $fees->display_amount($fee_row['buyout_fee']); ?>/s?n ph?m</td>
      </tr>
    <?php } ?>
  <?php if ($fee_row['makeoffer_fee'] > 0) { ?>
      <tr class="c2">
            ...
            <td align="center" class="fees_column"><?php echo $fees->display_amount($fee_row['makeoffer_fee']); ?>/s?n ph?m</td>
      </tr>
    <?php } ?>
  <?php if ($fee_row['custom_start_fee'] > 0) { ?>
      <tr class="c2">
            ...
            <td align="center" class="fees_column"><?php echo $fees->display_amount($fee_row['custom_start_fee']); ?>/s?n ph?m</td>
      </tr>
    <?php } ?>
  <?php if ($fee_row['video_fee'] > 0) { ?>
      <tr class="c2">
            ...
            <td align="center" class="fees_column"><?php echo $fees->display_amount($fee_row['video_fee']); ?>/s?n ph?m</td>
      </tr>
    <?php } ?>
  <?php if ($fee_row['wanted_ad_fee'] > 0) { ?>
      <tr class="c2">
            ...
            <td align="center" class="fees_column"><?php echo $fees->display_amount($fee_row['wanted_ad_fee']); ?>/s?n ph?m</td>
      </tr>
    <?php } ?>
    </table>
  </div>
