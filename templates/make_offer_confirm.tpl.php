  ...
  <form action="make_offer.php" method="post">
    ...
    <tr>
      <td class="contentfont"><table width="100%" border="0" cellpadding="3" cellspacing="2">
          ...
          <?php if ($setts['makeoffer_private']) { ?>
              <tr class="c1">
                <td width="150" align="right"><strong>
                    <?php echo MSG_OFFER_RANGE; ?></strong></td>
                <td><?php echo $item->offer_range($item_details); ?></td>
              </tr>
            <?php } ?>
          <tr class="c1">
            <td width="150" align="right"><strong>
                <?php echo MSG_OFFER_AMOUNT; ?></strong></td>
            <td><?php echo $item_details['currency']; ?>
              <input name="amount" type="text" id="amount" value="<?php echo $amount; ?>" size="15" onkeypress="return noenter()"></td>
          </tr>
