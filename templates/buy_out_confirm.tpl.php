...
?>
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="sell_table">
      ...
      <td class="contentfont"><table width="100%" border="0" cellpadding="3" cellspacing="2">
          ...
          <tr class="c1">
            <td width="150" align="right"><strong>
                <?php echo MSG_BUYOUT_PRICE; ?></strong></td>
        ...
        <table width="100%" border="0" cellpadding="4" cellspacing="2" class="errormessage">
          <tr>
            <td width="150" align="center"><input class="buttons" name="form_buyout_proceed" type="submit" id="form_buyout_proceed" value="<?php echo GMSG_PROCEED; ?>">
            </td>
