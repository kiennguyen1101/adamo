...
<table width="100%" border="0" cellpadding="3" cellspacing="3" class="fside">
  <form action="tax_settings.php" method="post" name="form_tax" onSubmit="submit_form(form_tax)">
    ...
    <input type="hidden" name="tax_id" value="<?php echo $tax_details['tax_id']; ?>" />
    <input type="hidden" name="operation" value="submit" />
    <tr>
      <td colspan="2" class="c4"><img src="images/subt.gif" align="absmiddle" hspace="4" vspace="2"> <?php echo $manage_box_title; ?></td>
    </tr>
    <tr class="c2">
      <td nowrap><b><?php echo AMSG_TAX_NAME; ?></b></td>
      <td width="100%"><input type="text" name="tax_name" value="<?php echo $tax_details['tax_name']; ?>" size="50" /></td>
    </tr>
    <tr class="c1">
      <td nowrap><b><?php echo AMSG_TAX_RATE; ?></b></td>
      <td width="100%"><input type="text" name="amount" value="<?php echo $tax_details['amount']; ?>" size="10" />
        %</td>
    </tr>
    <tr class="c2">
      <td nowrap><b><?php echo AMSG_APPLIED_BY; ?></b></td>
      <td width="100%"><table width="100%" border="0" cellspacing="2" cellpadding="2">
          <tr>
            <td width="45%">[ <?php echo AMSG_ALL_COUNTRIES; ?> ] </td>
            <td width="10%">&nbsp;</td>
            <td width="45%">[ <?php echo AMSG_SELECTED_COUNTRIES; ?> ] </td>
          </tr>
          <tr>
            <td><?php echo $all_countries_table_seller; ?></td>
            ...
            <td><?php echo $selected_countries_table_seller; ?></td>
          </tr>
        </table></td>
    </tr>
    <tr class="c2">
      <td nowrap><b><?php echo AMSG_APPLIES_TO; ?></b></td>
      <td width="100%"><table width="100%" border="0" cellspacing="2" cellpadding="2">
          <tr>
            <td width="45%">[ <?php echo AMSG_ALL_COUNTRIES; ?> ] </td>
            <td width="10%">&nbsp;</td>
          ...
          <tr>
            <td><?php echo $all_countries_table; ?></td>
            ...
            <td><?php echo $selected_countries_table; ?></td>
          </tr>
        </table></td>
    </tr>
    <tr class="c1">
      <td nowrap><b><?php echo AMSG_USERS_ALLOWED_TO_CHARGE_TAX; ?></b></td>
      <td width="100%"><?php echo $tax_settings_allowed_users_box; ?></td>
    </tr>
    <tr>
