...
<table width="100%" border="0" cellpadding="3" cellspacing="3" class="fside">
  <form action="table_bid_increments.php" method="post">
    <tr class="c3">
      <td colspan="3"><img src="images/subt.gif" align="absmiddle" hspace="4" vspace="2"> <b><?php echo strtoupper($subpage_title); ?></b></td>
    </tr>
    <tr valign="top">
      <td align="center"><table width="100%" border="0" cellpadding="3" cellspacing="1">
          <tr class="c4">
            <td width="20">&nbsp;</td>
            <td width="120"><?php echo GMSG_FROM; ?></td>
            <td width="120"><?php echo GMSG_TO; ?></td>
            <td><?php echo AMSG_INCREMENT_AMOUNT; ?></td>
            <td width="80" align="center"><?php echo AMSG_DELETE; ?></td>
          </tr>
          <?php echo $bid_increments_page_content; ?>
        </table></td>
    </tr>
    <tr class="c4">
      <td><img src="images/subt.gif" align="absmiddle" hspace="4" vspace="2"> <?php echo AMSG_ADD_INCREMENT; ?></td>
    </tr>
    <tr>
