...
#################################################################
  ...
  if ($session->value('adminarea') != 'Active') {
    ...
    if (!in_array($page_handle, $custom_fields_pages)) {
      ...
      $form_submitted = FALSE; ## MyPHPAuction 2009 begin insert/update/delete operations
      if ($_REQUEST['do'] == 'add_section') {## MyPHPAuction 2009 begin form check
      ...
      }## MyPHPAuction 2009 end insert/update/delete operations
      ...
      switch ($page_handle) {
        ...
        case 'wanted_ad':
          ...
          break;
      }## MyPHPAuction 2009 now we get all sections, starting with section 0, and add them into the template
      ...
      $page_content = $custom_fld->admin_display_section($page_handle); ## MyPHPAuction 2009 the no section tab## MyPHPAuction 2009 now create the fields with no section (here all fields and all boxes in those fields with section_id=0 will be created
