...
else
{
	...
	else if ($_REQUEST['do'] == 'activate_user')
	{
		...
		if ($approved)
		{## MyPHPAuction 2009 users counter - activate/inactivate all the user's auctions## MyPHPAuction 2009 but only if his account is approved - also activate/suspend the user's auctions
