...
The %2$s offer has that you have made on %3$s has been removed by the seller.
...
<br>
The %2$s offer has that you have made on %3$s has been removed by the seller. <br>
<br>
...
The %5$s staff';
  ...
  send_mail($row_details['email'], 'Auction ID: ' . $offer_details['auction_id'] . ' - Offer Rejected', $text_message, $this->setts['admin_email'], $html_message, null, $send);
?>