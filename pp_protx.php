...
#################################################################
  ...
  if (preg_match('/Amount=([^&]+)&/si', $protx_plain, $matches))
    $protx_amount = $matches[1];
  if (preg_match('/Status=([^&]+)&/si', $protx_plain, $matches))
    $protx_status = $matches[1];
  if (preg_match('/Currency=([^&]+)&/si', $protx_plain, $matches))
    $protx_currency = $matches[1];
  if (preg_match('/VPSTxId=([^&]+)&/si', $protx_plain, $matches))
    $protx_txnid = $matches[1];
