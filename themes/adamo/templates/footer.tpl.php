...
<div><img src="<?php echo CURRENT_THEME; ?>images/pixel.gif" width="1" height="5"></div>
<div style="padding: 5px; border-top:1px solid #cccccc; color:#9999FF;overflow: hidden;margin-bottom: 20px;" class="footerfont">
    ...
    <div class="footer_column">
        <h2>Đối tác</h2>
        <a href=""><img src="<?php echo CURRENT_THEME; ?>images/SSL_200x40_ani1.gif" border="0"></a>
        ...
        <img src="<?php echo CURRENT_THEME; ?>images/nldb_s_200.png" border="0">
    </div>
</div>
</body>
</html>