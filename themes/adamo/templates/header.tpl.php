    ...
    <head>
      ...
      <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
        ...
        <link href="themes/<?php echo $setts['default_theme']; ?>/css/style.css" rel="stylesheet" type="text/css">
          <link href="themes/<?php echo $setts['default_theme']; ?>/css/main_fl.css" rel="stylesheet" type="text/css">
            <style type="text/css">
              <!--
              .lb {
                background-image:  url(themes/<?php echo $setts['default_theme']; ?>/images/lb_bg.gif);
              }
              .db {
                background-image:  url(themes/<?php echo $setts['default_theme']; ?>/images/db_bg.gif);
              }
              <?php
            ...
            <script language="javascript" src="themes/<?php echo $setts['default_theme']; ?>/js/main.js" type="text/javascript"></script>
                                          ...
                                          <tr valign="top">
                                            ...
                                            ?>"><script language="javascript">
                                                ...
                                                <br>
                                                  ...
                                                  <div><img src='themes/<?php echo $setts['default_theme']; ?>/images/pixel.gif' width='1' height='5'></div>
                                                  <br />
                                                  <div align="center"><a href="rss_feed.php"><img src="themes/<?php echo $setts['default_theme']; ?>/images/system/rss.gif" border="0" alt="" align="absmiddle"></a></div>
                                            ...
                                            ?>"><img src="themes/<?php echo $setts['default_theme']; ?>/images/pixel.gif" width="10" height="1"></td>
                                            <td width="100%">
                                              ...
                                              <?php if (substr(strrchr($_SERVER['PHP_SELF'], '/'), 1) == "index.php") {
                                                  ...
                                                  <?php if ($member_active != 'Active') { ?>
                                                    <div><a href="<?php echo process_link('register'); ?>"><img src="themes/<?php echo $setts['default_theme']; ?>/images/newuser.jpg" border="0"></a></div>
                                                    <div><img src="themes/<?php echo $setts['default_theme']; ?>/images/pixel.gif" width="1" height="5"></div>
                                                  <?php } ?>
