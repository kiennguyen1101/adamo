...
<html xmlns:og='http://ogp.me/ns#' xmlns="http://www.w3.org/1999/xhtml" xmlns:og="http://ogp.me/ns#">
...
<head>
    ...
    <link href="<?php echo CURRENT_THEME; ?>css/style.css" rel="stylesheet" type="text/css">
    <link href="<?php echo CURRENT_THEME; ?>css/main_fl.css" rel="stylesheet" type="text/css">
    <link href="<?php echo CURRENT_THEME; ?>css/adamo.css" rel="stylesheet" type="text/css">
    <link href="<?php echo CURRENT_THEME; ?>css/reset.css" rel="stylesheet" type="text/css">
    <link rel="stylesheet" href="<?php echo CURRENT_THEME; ?>css/nivo-slider.css"
          type="text/css" media="screen"/>
    <link rel="stylesheet" href="<?php echo CURRENT_THEME; ?>js/nivo_slider/themes/light/light.css"
          type="text/css" media="screen"/>
    <?php
    if (isset($_GET['auction_id'])) {
        $main_image = $db->get_sql_field("SELECT media_url FROM " . DB_PREFIX . "auction_media WHERE
      			auction_id='" . $_GET['auction_id'] . "' AND media_type=1 AND upload_in_progress=0 ORDER BY media_id ASC LIMIT 0,1", 'media_url');
        ?>

        <link rel="image_src"
              href="<?php echo SITE_PATH; ?>thumbnail.php?pic=<?php echo $main_image; ?>&w=500&sq=Y&b=Y"/>
    <?php } ?>


    <script src="<?php echo CURRENT_THEME; ?>js/jquery-2.0.0.min.js" type="text/javascript"></script>
    <script src="<?php echo CURRENT_THEME; ?>js/nivo_slider/jquery.nivo.slider.pack.js"
            type="text/javascript"></script>
    <script src="<?php echo CURRENT_THEME; ?>js/jquery-ui-1.10.2.custom.min.js"></script>
    <!-- script for share this in product detail page -->
    <script type="text/javascript" src="http://w.sharethis.com/button/buttons.js"></script>
    <script
        type="text/javascript">stLight.options({publisher: "ur-c3f4d9c-f04c-766f-7689-f3cc1fd096bb", doNotHash: false, doNotCopy: false, hashAddressBar: false});</script>
    <!-- script for orther items slider -->
    <script src="<?php echo CURRENT_THEME; ?>js/jquery.bxslider.min.js"></script>
    <!-- bxSlider CSS file -->
    <link href="<?php echo CURRENT_THEME; ?>css/jquery.bxslider.css" rel="stylesheet"/>
    <script>
        $(function () {
            $("#tabs").tabs({
    ...
    <style type="text/css">
        <!--
        .lb {
            background-image: url(<?php echo CURRENT_THEME; ?>images/lb_bg.gif);
        }

        .db {
            background-image: url(<?php echo CURRENT_THEME; ?>images/db_bg.gif);
        }
    ...
    <script language="javascript" src="<?php echo CURRENT_THEME; ?>js/main.js"
            type="text/javascript"></script>
    <script type="text/javascript" src="<?php echo CURRENT_THEME; ?>js/countdownpro.js"
            defer="defer"></script>
    <?php
    for ($i = 1; $i < 50; $i++) {
        ?>
...
<div class="top_link"> <!--!!!!!!!!!!!!without right menu-->
    <div class="user_links">
        <div class="welcome_link" style="<?php if (substr(strrchr($_SERVER['PHP_SELF'], '/'), 1) == "register.php") {
            echo "display:none";
        } ?><?php if (substr(strrchr($_SERVER['PHP_SELF'], '/'), 1) == "login.php") {
            echo "display:none";
        } ?>">
            <?php
...
<div id="header_box">
    <div id="header_logo">
        <a href="<?php echo $index_link; ?>"><img src="images/myphpauction.gif?<?php echo rand(2, 9999); ?>" alt="logo"
                                                  width="200"></a>
            ...
            <div id="home_slider" class="slider-wrapper theme-light">
                <div id="slider" class="nivoSlider">
                    ...
                    foreach ($files as $file) {
                        echo "<img src='" . CURRENT_THEME . "images/" . $file . "' alt='slider'/>";
                    }
                    ?>
                </div>
            </div>
    ...
    <div id="content">
        <?php if (substr(strrchr($_SERVER['PHP_SELF'], '/'), 1) != "sell_item.php") { ?>
            <div class="sidebar_left"
                 style="<?php if (substr(strrchr($_SERVER['PHP_SELF'], '/'), 1) == "register.php") {
                     echo "display:none";
                 } ?> <?php
        ...
        <div class="content_right"
             style="<?php if ($member_active != 'Active') echo "width:960px"; elseif ((substr(strrchr($_SERVER['PHP_SELF'], '/'), 1) == "categories.php") || (substr(strrchr($_SERVER['PHP_SELF'], '/'), 1) == "content_pages.php") || (substr(strrchr($_SERVER['PHP_SELF'], '/'), 1) == "search.php")) echo "width:960px"; else echo "width:960px"; ?>"><?php } ?>