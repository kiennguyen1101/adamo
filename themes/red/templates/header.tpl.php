                        ...
                        ?>">
                               <?php
                                 if ($member_active == 'Active') {
                                   ...
                                   ?> (<a href="<?php echo $login_link; ?>"><?php echo $login_btn_msg; ?></a>) <?php
                            }
                            else {
                              ?>
                                        ...
                                        <div id="main">
                                          <div id="content">
                                            <?php if (substr(strrchr($_SERVER['PHP_SELF'], '/'), 1) != "sell_item.php") { ?>
                                              <div class="sidebar_left" style="<?php
                                              if (substr(strrchr($_SERVER['PHP_SELF'], '/'), 1) == "register.php") {
                                                echo "display:none";
                                              }
                                              ?> <?php
                                            ...
                                            <?php } ?>			
                                            <div class="content_right" style="<?php
                                                 if ($member_active != 'Active')
                                                   echo "width:960px"; elseif ((substr(strrchr($_SERVER['PHP_SELF'], '/'), 1) == "categories.php") || (substr(strrchr($_SERVER['PHP_SELF'], '/'), 1) == "content_pages.php") || (substr(strrchr($_SERVER['PHP_SELF'], '/'), 1) == "search.php"))
                                                   echo "width:960px";
                                                 else
                                                   echo "width:960px";
                                                 ?>"><?php } ?>		