...
<head>
    ...
    <link rel="stylesheet" href="themes/<?php echo $setts['default_theme']; ?>/nivo_slider/nivo-slider.css"
          type="text/css" media="screen"/>
    <link rel="stylesheet" href="themes/<?php echo $setts['default_theme']; ?>/nivo_slider/themes/light/light.css"
          type="text/css" media="screen"/>
    <?php
    ...
    <script src="themes/<?php echo $setts['default_theme']; ?>/nivo_slider/jquery.nivo.slider.pack.js"
    ...
    <script language="javascript" src="themes/<?php echo $setts['default_theme']; ?>/main.js"
            type="text/javascript"></script>
    <script type="text/javascript" src="themes/<?php echo $setts['default_theme']; ?>/countdownpro.js"
            defer="defer"></script>
    <?php
    for ($i = 1; $i < 50; $i++) {
        ?>
            ...
            <div id="home_slider" class="slider-wrapper theme-light">
                <div id="slider" class="nivoSlider">
                    ...
                    foreach ($files as $file) {
                        echo "<img src='" . CURRENT_THEME . "nivo_slider/images/" . $file . "' alt='slider'/>";
                    }
                    ?>
                </div>
            </div>
