...
#################################################################
  ...
  if ($setts['enable_stores']) {
    ...
    $template->set('header_stores_page', $header_stores_page); ## MyPHPAuction 2009 store search procedure
    ...
    $select_condition = "LEFT JOIN " . DB_PREFIX . "fees_tiers s ON u.shop_account_id=s.tier_id 
		WHERE	u.active=1 AND u.shop_active=1 AND s.store_featured=1";
