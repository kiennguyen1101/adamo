...
//      Yii::trace('Flushing cache', 'system.caching.' . get_class($this));
    ...
    protected function getValue($key) {
      throw new Exception('yii', printf('%s does not support get() functionality.', get_class($this)));
    }
    ...
    protected function setValue($key, $value, $expire) {
      throw new Exception('yii', printf('%s does not support set() functionality.', get_class($this)));
    }
    ...
    protected function addValue($key, $value, $expire) {
      throw new Exception('yii', printf('%s does not support add() functionality.', get_class($this)));
    }
    ...
    protected function deleteValue($key) {
      throw new Exception('yii', printf('%s does not support delete() functionality.', get_class($this)));
    }
    ...
    protected function flushValues() {
      throw new Exception('yii', printf('%s does not support flushValues() functionality.', get_class($this)));
    }
