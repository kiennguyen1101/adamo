  ...
  class shop extends database {
    ...
    function shop_save_pages($post_details, $user_id) {
      ...
      $this->query("UPDATE " . DB_PREFIX . "users SET 
			...
			shop_nb_feat_items='" . $post_details['shop_nb_feat_items'] . "', shop_nb_ending_items='" . $post_details['shop_nb_ending_items'] . "', 
    ...
    function shop_save_subscription($post_details, $user_id) {
      ...
      $shop_details = $this->get_sql_row("SELECT enable_aboutme_page, shop_account_id, shop_active FROM
       ...
       */
      if (($post_details['shop_account_id'] != $shop_details['shop_account_id'] && $shop_details['shop_active'] && $post_details['shop_account_id']) || ($post_details['shop_active'] && !$shop_details['shop_active'])) {
