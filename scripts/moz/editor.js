...
function RENDER(sPreloadHTML)
{
    ...
    for (var i = 0; i < this.buttonMap.length; i++)
    {
        ...
        switch (sButtonName)
        {
            ...
            case "Print":
                if (this.btnPrint)
                    sHTMLIcons += this.writeIconStandard("btnPrint" + this.oName, "document.getElementById('idContent" + this.oName + "').contentWindow.print()", "btnPrint.gif", getTxt("Print"));
                break;
            case "SpellCheck":
            ...
            case "PasteWord":
                if (this.btnPasteWord)
                    sHTMLIcons += this.writeIconStandard("btnPasteWord" + this.oName, "modelessDialogShow('" + this.scriptPath + "paste_word.htm',400,280)", "btnPasteWord.gif", getTxt("Paste from Word"));
                break;
            case "PasteText":
                if (this.btnPasteText)
                    sHTMLIcons += this.writeIconStandard("btnPasteText" + this.oName, "modelessDialogShow('" + this.scriptPath + "paste_text.htm',400,280)", "btnPasteText.gif", getTxt("Paste Text"));
                break;
            case "Bold":
                if (this.btnBold)
                    sHTMLIcons += this.writeIconToggle("btnBold" + this.oName, this.oName + ".doCmd('Bold')", "btnBold.gif", getTxt("Bold"));
                break;
            case "Italic":
                if (this.btnItalic)
                    sHTMLIcons += this.writeIconToggle("btnItalic" + this.oName, this.oName + ".doCmd('Italic')", "btnItalic.gif", getTxt("Italic"));
                break;
            case "Underline":
                if (this.btnUnderline)
                    sHTMLIcons += this.writeIconToggle("btnUnderline" + this.oName, this.oName + ".doCmd('Underline')", "btnUnderline.gif", getTxt("Underline"));
                break;
            case "Strikethrough":
                if (this.btnStrikethrough)
                    sHTMLIcons += this.writeIconToggle("btnStrikethrough" + this.oName, this.oName + ".doCmd('Strikethrough')", "btnStrikethrough.gif", getTxt("Strikethrough"));
                break;
            case "Superscript":
            ...
            case "ForeColor":
                if (this.btnForeColor)
                    sHTMLIcons += this.writeIconStandard("btnForeColor" + this.oName, this.oName + ".expandSelection();" + this.oName + ".oColor1.show(this)", "btnForeColor.gif", getTxt("Foreground Color"));
                break;
            case "BackColor":
                if (this.btnBackColor)
                    sHTMLIcons += this.writeIconStandard("btnBackColor" + this.oName, this.oName + ".expandSelection();" + this.oName + ".oColor2.show(this)", "btnBackColor.gif", getTxt("Background Color"));
                break;
            case "Bookmark":
                if (this.btnBookmark)
                    sHTMLIcons += this.writeIconStandard("btnBookmark" + this.oName, "modelessDialogShow('" + this.scriptPath + "bookmark.htm',245,170)", "btnBookmark.gif", getTxt("Bookmark"));
                break;
            case "Hyperlink":
                if (this.btnHyperlink)
                    sHTMLIcons += this.writeIconStandard("btnHyperlink" + this.oName, "modelessDialogShow('" + this.scriptPath + "hyperlink.htm',420,150)", "btnHyperlink.gif", getTxt("Hyperlink"));
                break;
            case "CustomTag":
            ...
            case "Image":
                if (this.btnImage)
                    sHTMLIcons += this.writeIconStandard("btnImage" + this.oName, "modelessDialogShow('" + this.scriptPath + "image.htm',440,305)", "btnImage.gif", getTxt("Image"));
                break;
            case "Flash":
                if (this.btnFlash)
                    sHTMLIcons += this.writeIconStandard("btnFlash" + this.oName, "modelessDialogShow('" + this.scriptPath + "flash.htm',410,205)", "btnFlash.gif", getTxt("Flash"));
                break;
            case "Media":
                if (this.btnMedia)
                    sHTMLIcons += this.writeIconStandard("btnMediah" + this.oName, "modelessDialogShow('" + this.scriptPath + "media.htm',420,232)", "btnMedia.gif", getTxt("Media"));
                break;
            case "ContentBlock":
                if (this.btnContentBlock)
                    sHTMLIcons += this.writeIconStandard("btnContentBlock" + this.oName, this.cmdContentBlock, "btnContentBlock.gif", getTxt("Content Block"));
                break;
            case "InternalLink":
                if (this.btnInternalLink)
                    sHTMLIcons += this.writeIconStandard("btnInternalLink" + this.oName, this.cmdInternalLink, "btnInternalLink.gif", getTxt("Internal Link"));
                break;
            case "CustomObject":
                if (this.btnCustomObject)
                    sHTMLIcons += this.writeIconStandard("btnCustomObject" + this.oName, this.cmdCustomObject, "btnCustomObject.gif", getTxt("Object"));
                break;
            case "Table":
                if (this.btnTable)
                {
            ...
            case "Characters":
                if (this.btnCharacters)
                    sHTMLIcons += this.writeIconStandard("btnCharacters" + this.oName, "modelessDialogShow('" + this.scriptPath + "characters.htm',520,150)", "btnSymbol.gif", getTxt("Special Characters"));
                break;
            case "Line":
                if (this.btnLine)
...
function replaceWithSpan(oEditor, arrStyles, sClassName, blockTag)
{
    ...
    if (startFont == null)
        startFont = range.startContainer.nextSibling;
    startFont.setAttribute("startcont", "this");

    var endFont = GetElement(range.endContainer, "FONT");
    if (endFont == null)
        endFont = range.endContainer.prevSibling;
    if (endFont != null)
        endFont.setAttribute("endcont", "this");
    ...
    while (allFonts.length > 0)
    {
        ...
        if (f.childNodes && f.childNodes.length == 1 && f.childNodes[0].nodeType == 1 && f.childNodes[0].nodeName == useBlock)
        {
            ...
            if (f.getAttribute("startcont") == "this")
                startCont = newSpan;
            if (f.getAttribute("endcont") == "this")
                endCont = newSpan;
...
function doDown(btn)
{
    ...
    if (btnArr[0] != "disabled")
        btn.style.top = (-iconHeight2 + iconOffsetTop) + "px";//no.3
}
function doOut(btn)
{
    ...
    btnArr = buttonArrays[btn.id];
    if (btnArr[0] == "active")
        btn.style.top = (-iconHeight3 + iconOffsetTop) + "px";//no.4 (remain active/pushed)
    if (btnArr[0] == "inactive")
