...
// cowntdown function. Set the date by modifying the date in next line (June 1, 2012 00:00:00):
	var austDay = new Date("May 11, 2013 10:00:00");
...
// toggle function
	$('a.trigger').click(function(){
		if( ! $(this).hasClass('active')){
			...
			$('#container').append('<div class="text">Adamo.vn</div>').show('slow');
		} else {
		$("#totoggle").slideToggle("slow");
...
$(document).ready( function(){
	...
	$.supersized({
		...
		slides 					:  	[			// Slideshow Images
											{image : 'images/gallery/anh1.jpg', thumb : 'images/gallery/thumb1.jpg', url : ''},
											{image : 'images/gallery/anh2.jpg', thumb : 'images/gallery/thumb2.jpg', url : ''},
											{image : 'images/gallery/anh3.jpg', thumb : 'images/gallery/thumb3.jpg', url : ''},
											{image : 'images/gallery/anh4.jpg', thumb : 'images/gallery/thumb4.jpg', url : ''},
											{image : 'images/gallery/anh5.jpg', thumb : 'images/gallery/thumb5.jpg', url : ''}	
									]
	});
});
